...
import './Card.css';
import { useFavCard } from '../../Context/FavCard';

const Card = ({ card }) => {
    const { favCards, toggleFavCard } = useFavCard();

    const isFavCard = favCards.includes(card._id);

    const handleClickedFavCard = () => {
        toggleFavCard(card._id);
        ...
        <div className="card">
            ...
            <div className="card-body">
                ...
                <section className="iconCard d-flex mt-4 justify-content-end gap-3">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill={!isFavCard ? 'currentColor' : 'red'} onClick={handleClickedFavCard} className="bi bi-heart-fill" viewBox="0 0 16 16">
